...
def run_one_seed(
    ...
    if stereo is not None:
        ...
        tag_metrics = eval_pair_metrics(model, terminal_tag_pairs, "Sequence_untagged", "Sequence_tagged")
...
def main() -> None:
    ...
    print(f"[data] Loading stereopep dataset (dataset={args.dataset}) …")
    ...
    stem = results_stem("results_transformer_scratch", args.dataset)
    ...
    test_metrics, train_metrics, stereo_metrics, stereo_trainval_metrics, tag_metrics, sub_metrics, history = run_one_seed(
        ...
        ds["test"]["Peptide"], y_test, stereo, stereo_trainval,
        terminal_tag_pairs, sub_pairs, weights_path=weights_path,
    )
